...
from nose.tools import eq_, raises, ok_, nottest
...
def test_kanji_detection():
    ...
    eq_('kanji', qr.mode)
    eq_(s.encode('shiftjis'), qr.data)

@nottest # Segno's API does not provide a "builder" attribute
